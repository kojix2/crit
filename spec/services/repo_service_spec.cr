...
describe Gcirt::Services::RepoService do
  before_each do
    ...
    temp_dir = File.join(Dir.tempdir, "gcirt_test_#{Time.utc.to_unix}")
  ...
  describe ".list_files" do
    it "returns files in the root directory" do
      files = Gcirt::Services::RepoService.list_files("test", "master")
    ...
    it "handles repository names with .git extension" do
      files = Gcirt::Services::RepoService.list_files("test.git", "master")
      files.should_not be_nil
    ...
    it "returns files in a subdirectory" do
      files = Gcirt::Services::RepoService.list_files("test", "master", "src")
      files.should_not be_nil
    ...
    it "returns nil for non-existent repository" do
      files = Gcirt::Services::RepoService.list_files("nonexistent", "master")
      files.should be_nil
    end
  end
  ...
  describe ".get_file_content" do
    it "returns content of a file" do
      content = Gcirt::Services::RepoService.get_file_content("test", "master", "README.md")
    ...
    it "handles repository names with .git extension" do
      content = Gcirt::Services::RepoService.get_file_content("test.git", "master", "README.md")
      content.should_not be_nil
    ...
    it "returns nil for non-existent file" do
      content = Gcirt::Services::RepoService.get_file_content("test", "master", "nonexistent.txt")
  ...
  describe ".list_branches" do
    it "returns list of branches" do
      branches = Gcirt::Services::RepoService.list_branches("test")
      branches.should_not be_empty
      branches.should contain("master")
    end

    it "handles repository names with .git extension" do
      branches = Gcirt::Services::RepoService.list_branches("test.git")
      branches.should_not be_empty
      branches.should contain("master")
    end

    it "returns empty array for non-existent repository" do
      branches = Gcirt::Services::RepoService.list_branches("nonexistent")
